package cr.ac.gdeduardofonseca
...
class MainActivity : AppCompatActivity(), CoroutineScope by MainScope(){
    ...
    var listaDatos: MutableList<String>? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val vistaDatos = findViewById<ListView>(R.id.vista_lista)
        arrayAdapter = ArrayAdapter(this, android.R.layout.simple_list_item_1, listaDatos!!)
        vistaDatos.adapter = arrayAdapter
    }
